...
import com.springbootut1.springbootut1.entity.ErrorMessage;
...
public class RestResponseEntityExeceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage>  departmentNotFoundException(
            DepartmentNotFoundExeception exeception,
            WebRequest request
    ){
        ErrorMessage message = new ErrorMessage(HttpStatus.NOT_FOUND,exeception.getMessage());
